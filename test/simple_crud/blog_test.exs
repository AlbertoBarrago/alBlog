defmodule SimpleCrud.BlogTest do
  ...
  describe "articles" do
    ...
    import SimpleCrud.AccountsFixtures, only: [user_scope_fixture: 0]
    ...
    test "create_article/2 with valid data creates a article" do
      valid_attrs = %{title: "some title", category: "some category", slug: "some slug", content: "some content", published_at: ~U[2025-11-16 18:24:00Z]}
      scope = user_scope_fixture()
    ...
    test "update_article/3 with valid data updates the article" do
      scope = user_scope_fixture()
      article = article_fixture(scope)
      update_attrs = %{title: "some updated title", category: "some updated category", slug: "some updated slug", content: "some updated content", published_at: ~U[2025-11-17 18:24:00Z]}
