defmodule Alblog.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias Alblog.Accounts.UserToken
  ...
  if the token is being used within a certain period (defaults to @reset_password_validity_in_hours).
  """
